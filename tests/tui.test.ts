...
test("render does not throw with full state", () => {
  const state: AppState = {
    ...
    portfolio: { positions: [{ symbol: "BTC/USDT", quantity: 0.1, entryPrice: 40000, currentPrice: 41000 }], totalValueUsd: 14100, cashUsd: 10000, dailyTradeCount: 1 },
    lastSignal: { type: "buy", symbol: "BTC/USDT", confidence: 0.8, reason: "positive momentum" },
